...
namespace WebAPI.Controller
{
    ...
    public class StudentModelsController : ControllerBase
    {
        ...
        // GET: api/StudentModels/names
        [HttpGet("names")]
        public async Task<ActionResult<IEnumerable<string>>> StudentNames()
        {
            if (_context.StudentModel == null)
            {
                return NotFound();
            }
            return await _context.StudentModel.Select(t => t.StudentName).ToListAsync();
        }
